...
This overlay opts one `oh web` process into Schedule reminders without changing the shipped default Web composition:

```sh
oh web --patch examples/web-schedule/cordis.yml
```
