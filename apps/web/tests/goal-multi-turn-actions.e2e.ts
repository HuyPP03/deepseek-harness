...
import { parseSessionLog } from '@open-harness/oh-llm-replay'
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@open-harness/oh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@open-harness/oh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@open-harness/oh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@open-harness/oh-skill-filesystem"}\n',
