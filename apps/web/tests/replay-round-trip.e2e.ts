...
// in the temp workspace) all run; the model adapter is oh-llm-replay (keyless)
...
// Record: OH_SNAPSHOT=record rewrites session.jsonl, then a keyless
// OH_SNAPSHOT=refresh regenerates ui.expected.md.
