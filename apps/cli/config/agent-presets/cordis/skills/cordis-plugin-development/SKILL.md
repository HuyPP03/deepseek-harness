...
Service instances, Event payloads, Slot props, Session and Conversation Snapshots, Tool state, and other Open Harness/Cordis objects are internal live data.
