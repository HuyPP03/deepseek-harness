...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@open-harness/oh-workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
      name: '@open-harness/oh-tool-workflow'
```
