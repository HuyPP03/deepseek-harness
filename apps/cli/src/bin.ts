#!/usr/bin/env node
/**
 * oh — command-line entry. Dynamic imports per mode keep unrelated modes out
...
import { loadLayeredEnv } from '@open-harness/oh-app-boot'
...
const invocation = parseOhArgs(process.argv.slice(2), readVersion())
