 ...
 * tool family (`@open-harness/oh-tool-bash`, `@open-harness/oh-tool-fs`): the
...
export const WIDER_MODES: Record<string, readonly SandboxMode[]> = {
  'read-only': ['workspace-write', 'workspace-refs-write', 'danger-full-access'],
  'workspace-write': ['workspace-refs-write', 'danger-full-access'],
  'workspace-refs-write': ['danger-full-access'],
}
 ...
 */
export const ESCALATION_TARGETS: readonly SandboxMode[] = ['workspace-write', 'workspace-refs-write', 'danger-full-access']
