 ...
 *
 * @module oh-sandbox-policy/session-mode
 */
...
export const SANDBOX_MODES: readonly SandboxMode[] = ['read-only', 'workspace-write', 'workspace-refs-write', 'danger-full-access']
