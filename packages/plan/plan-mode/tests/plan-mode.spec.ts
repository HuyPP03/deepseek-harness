...
import ToolRuntime, { RUN_CODE_NAME, defineContentToolFixture } from '@open-harness/oh-tools'
import { Session, SessionId, type UserMessage } from '@open-harness/oh-session'
import AgentRegistry, { agentEvents, type Agent } from '@open-harness/oh-agent'
...
import { CodeRuntime, type CodeRunRequest, type CodeRunResult } from '@open-harness/oh-code-runtime'
...
/**
 * Drives the REAL plugin: mounts `oh-plan-mode` beside real `SystemPrompt` and
