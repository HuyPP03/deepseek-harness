/**
 * Package-owned invariant companion for `@open-harness/oh-user-questions`.
 * @module @open-harness/oh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-user-questions'
