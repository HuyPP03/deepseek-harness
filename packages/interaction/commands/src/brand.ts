/**
 * oh-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@open-harness/oh-brand`; this module
 ...
 * loading the host plugin's Context merges — the `oh-llm/brand` shape.
 *
 * @module @open-harness/oh-commands/brand
 */
