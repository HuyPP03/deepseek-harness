/**
 * Package-owned invariant companion for `@open-harness/oh-hooks-claude-code`.
 * @module @open-harness/oh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-hooks-claude-code'
