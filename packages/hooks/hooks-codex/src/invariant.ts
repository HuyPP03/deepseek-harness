/**
 * Package-owned invariant companion for `@open-harness/oh-hooks-codex`.
 * @module @open-harness/oh-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-hooks-codex'
