/**
 * Package-owned invariant companion for `@open-harness/oh-sdk-jsonrpc-demo`.
 * @module @open-harness/oh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-sdk-jsonrpc-demo'
