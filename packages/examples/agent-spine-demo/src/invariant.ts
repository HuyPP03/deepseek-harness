/**
 * Package-owned invariant companion for `@open-harness/oh-agent-spine-demo`.
 * @module @open-harness/oh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-agent-spine-demo'
