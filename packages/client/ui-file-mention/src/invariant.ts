/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-file-mention`.
 * @module @open-harness/oh-client-ui-file-mention/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-file-mention'
