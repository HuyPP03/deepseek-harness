/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-workspace`.
 * @module @open-harness/oh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-workspace'
