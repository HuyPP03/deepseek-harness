/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-settings-general`.
 * @module @open-harness/oh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-settings-general'
