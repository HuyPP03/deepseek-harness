...
import type { WebBootGraph, ClientModuleRegistry } from '@open-harness/oh-client-modules'
import type { WebRoute, WebServer } from '@open-harness/oh-host-webserver'
...
beforeEach(() => { dir = mkdtempSync(join(tmpdir(), 'oh-hmr-')) })
