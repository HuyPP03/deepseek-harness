/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-deliverables`.
 * @module @open-harness/oh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-deliverables'
