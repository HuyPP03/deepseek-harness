...
import type { ChatFileMentions } from '@open-harness/oh-client-ui-conversation/client'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { en, vi, zh }), 'ui-deliverables: dictionaries')
  ctx.slots.inject(
