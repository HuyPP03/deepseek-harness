...
export class FakeApiClient implements IApiClient {
  ...
  onSetReferences: (payload: unknown) => Promise<RpcResponse<{ accepted: true }>> = () => Promise.resolve(ok({ accepted: true as const }))
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    setReferences: (payload: { sessionId: SessionId; referenceWorkspaceIds: WorkspaceId[] }) =>
      this.record('session.setReferences', payload, this.onSetReferences(payload)),
  }
  ...
  readonly jobs: IApiClient['jobs'] = {
    log: (payload: unknown) => this.record('jobs.log', payload, Promise.resolve(ok({
      text: '',
      truncated: false,
    }))),
  }
  ...
  readonly connectors: IApiClient['connectors'] = {
    ...
    deviceLogin: payload => this.record('connector.deviceLogin', payload, Promise.resolve(ok({ status: 'ready', expiresAt: Date.now() }))),
