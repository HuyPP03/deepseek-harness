/**
 * Package-owned invariant companion for `@open-harness/oh-client-connection`.
 * @module @open-harness/oh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-connection'
