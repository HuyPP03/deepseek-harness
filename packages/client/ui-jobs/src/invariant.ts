/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-jobs`.
 * @module @open-harness/oh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-jobs'
