/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-input-trigger`.
 * @module @open-harness/oh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-input-trigger'
