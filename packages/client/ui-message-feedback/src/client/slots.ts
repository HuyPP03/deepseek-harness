 ...
 * @module @open-harness/oh-client-ui-message-feedback/client/slots
 */
...
import type { MessageId } from '@open-harness/oh-client-connection/client'
import type { MessageFeedbackRating } from '@open-harness/oh-message-feedback/types'
