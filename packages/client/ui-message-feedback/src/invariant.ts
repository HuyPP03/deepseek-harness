/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-message-feedback`.
 * @module @open-harness/oh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-message-feedback'
