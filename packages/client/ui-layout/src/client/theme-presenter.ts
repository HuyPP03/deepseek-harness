 ...
 * controls), `body[data-oh-dark-theme]` for the token palette, the active
 ...
 */
import type { ThemeSnapshot } from '@open-harness/oh-client-ui-theme/client'

/** Body attribute selecting the dark base palette in the token stylesheets. */
export const DARK_ATTRIBUTE = 'data-oh-dark-theme'
