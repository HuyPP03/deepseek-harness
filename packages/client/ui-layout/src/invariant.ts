/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-layout`.
 * @module @open-harness/oh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-layout'
