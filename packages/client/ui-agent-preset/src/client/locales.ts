...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  presetChatDescription:
    'Read-only general assistant with no working directory, for questions, explanations, and analysis; file access stays read-only and no coding tools are provided.',
  duplicate: 'Duplicate',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  presetChatName: '聊天模式',
  presetChatDescription: '无工作目录的只读通用助手，用于问答、解释与分析；文件访问只读，不提供编码类工具。',
  duplicate: '复制',
