...
import { en, presetDisplayText, vi, zh } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register('settings.agentPreset', { en, vi, zh }), 'ui-agent-preset: settings row dictionaries')
