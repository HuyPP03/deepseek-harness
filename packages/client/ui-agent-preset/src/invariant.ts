/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-agent-preset`.
 * @module @open-harness/oh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-agent-preset'
