/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-directory-picker-native`.
 * @module @open-harness/oh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-directory-picker-native'
