/**
 * Package-owned invariant companion for `@open-harness/oh-client-web-react`.
 * @module @open-harness/oh-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-web-react'
