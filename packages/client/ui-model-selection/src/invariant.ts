/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-model-selection`.
 * @module @open-harness/oh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-model-selection'
