...
import type { ModelSelection, SessionModels } from '@open-harness/oh-api-remotes/client'
...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { en, vi, zh }), 'ui-model-selection: dictionaries')
