/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-settings`.
 * @module @open-harness/oh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-settings'
