/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-skill`.
 * @module @open-harness/oh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-skill'
