/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-conversation`.
 * @module @open-harness/oh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-conversation'
