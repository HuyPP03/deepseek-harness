...
import type { UseProjection } from '@open-harness/oh-client-runtime/client'
// Type-only: the `contextPressure` / `contextBreakdown` projection key merges.
import type {} from '@open-harness/oh-token-meter/client'
 ...
 * order (English reads `45% of context used`; Chinese puts the reading after
 * the phrase).
 */
const READING_SLOT = '\u0000'
