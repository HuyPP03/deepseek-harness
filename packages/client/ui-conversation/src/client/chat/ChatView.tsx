...
import type { ConversationTimelineSnapshot } from '@open-harness/oh-client-runtime/client'
import { IconChevronDownOutline14 } from '@open-harness/oh-client-ui-primitives'
...
export function ChatView({
  useSession, useSessions, useStore, renderSlot, sessionId, openFile, openDetails, loadOlder, loadImage, inspectCall, chatScroll, forkAt,
  fileMentions, t,
}: ChatViewSlotProps) {
