...
import { DisclosureRow, IconCordisPluginOutline14, StateDot } from '@open-harness/oh-client-ui-primitives'
...
function leadingFor(state: CommandRowState): ReactNode {
  return state === 'error' ? <StateDot state="error" /> : <IconCordisPluginOutline14 size={14} />
}
