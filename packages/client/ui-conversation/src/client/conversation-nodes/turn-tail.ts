...
import { isAppendSurfaceEvent, toAssistantBlocks } from '@open-harness/oh-client-runtime/client'
import type {} from '@open-harness/oh-llm-retry/types'
import type {
...
declare module '@open-harness/oh-client-runtime/client' {
