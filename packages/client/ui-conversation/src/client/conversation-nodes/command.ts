...
import { isReplacementSurfaceEvent } from '@open-harness/oh-client-runtime/client'
import type { CompactionCheckpointSource } from '@open-harness/oh-compaction/checkpoint'
import type {} from '@open-harness/oh-compaction/types'
import type {} from '@open-harness/oh-commands/types'
import type { ManualCompactionChatData } from '../contract/chat-nodes.ts'
import { chatNode } from './common.ts'

declare module '@open-harness/oh-client-ui-conversation/client' {
