/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-permission-presets`.
 * @module @open-harness/oh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-permission-presets'
