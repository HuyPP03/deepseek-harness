/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-user-questions`.
 * @module @open-harness/oh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-user-questions'
