/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-tool`.
 * @module @open-harness/oh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-tool'
