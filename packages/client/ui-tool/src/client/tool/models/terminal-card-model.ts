...
import type { TerminalBlockLabels, TerminalBlockProps } from '@open-harness/oh-client-ui-primitives'
 ...
 * `ToolResultNode.call`/`callView` in oh-client-runtime), leaving a terminal
