...
import type { SessionProviderComponent, TranslateNS } from '@open-harness/oh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@open-harness/oh-client-ui-conversation/src/client/contract/slots.ts'
