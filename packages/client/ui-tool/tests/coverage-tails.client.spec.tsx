...
import type { RunningToolCall, SessionId, SessionListState, ToolResultNode } from '@open-harness/oh-client-runtime/client'
...
describe('Tool presentation tails', () => {
  ...
  it('a settled others-variant row renders the sparkle icon in the leading slot', () => {
    ...
    const props: GenericToolCardProps = {
      callId: 'c5', toolName: 'todo_write', block: settled, openFile: vi.fn(), openDetails: vi.fn(), t,
    }
