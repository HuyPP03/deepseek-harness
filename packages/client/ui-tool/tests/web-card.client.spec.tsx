...
import type { ToolResultView } from '@open-harness/oh-api-remotes/client'
import { bindSnapshotSelector } from '@open-harness/oh-client-web-react'
import type { SelectionTarget } from '@open-harness/oh-client-ui-conversation/client'
import type { ToolCallOwnerProps } from '@open-harness/oh-client-ui-tool/client'
import { IconGlobeOutline14 } from '@open-harness/oh-client-ui-primitives'
...
import { DetailsPanel } from '@open-harness/oh-client-ui-conversation/src/client/skeleton/DetailsPanel.tsx'
...
import { zh } from '@open-harness/oh-client-ui-conversation/src/client/locales.ts'
...
describe('chat row web body', () => {
  const ownerProps = (block: RunningToolCall | ToolResultNode, toolName: string): ToolCallOwnerProps => ({
    callId: block.callId, toolName, block, openFile: vi.fn(), openDetails: vi.fn(),
  })
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@open-harness/cordis').Context
