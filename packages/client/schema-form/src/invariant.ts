/**
 * Package-owned invariant companion for `@open-harness/oh-client-schema-form`.
 * @module @open-harness/oh-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-schema-form'
