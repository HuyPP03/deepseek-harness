...
import * as PluginConfigInvariant from '@open-harness/oh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@open-harness/oh-client-ui-settings-plugins')
