/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-settings-plugins`.
 * @module @open-harness/oh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-settings-plugins'
