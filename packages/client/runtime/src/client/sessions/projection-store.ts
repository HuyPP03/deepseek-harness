...
// (`/types`, zero imports), never the package root: the root's oh-agent →
// oh-session chain would drag the host `Context.sessions` merge into the
...
export type { SessionProjectionMap } from '@open-harness/oh-session-projection/types'
