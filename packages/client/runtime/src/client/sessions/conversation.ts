...
import type { TodoItem } from '@open-harness/oh-session/types'
import type {
...
/** Send/stop failure surfaced in the input error strip; op picks the user-facing copy (send vs stop failure). */
