/**
 * Package-owned invariant companion for `@open-harness/oh-client-runtime`.
 * @module @open-harness/oh-client-runtime/invariant
 */
...
import type { SlotMap } from '@open-harness/oh-client-ui-slots'
import type { InvariantInstaller } from '@open-harness/oh-invariants'

const PACKAGE_NAME = '@open-harness/oh-client-runtime'
