/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-theme`.
 * @module @open-harness/oh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-theme'
