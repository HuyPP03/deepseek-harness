/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-commands`.
 * @module @open-harness/oh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-commands'
