/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-primitives`.
 * @module @open-harness/oh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-primitives'
