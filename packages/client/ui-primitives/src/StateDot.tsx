...
// up clockwise with a stepped trail. Colors resolve through --oh-* tokens only.

import clsx from 'clsx'
import css from './StateDot.module.css'

/** Four-color state semantic (green done / amber user-attention / brand-red running ring / red error). */
