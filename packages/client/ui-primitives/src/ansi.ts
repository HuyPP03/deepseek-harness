...
const TOKEN_BY_BASIC_RGB: Record<string, string> = {
  '0,0,0': 'var(--oh-alias-label-primary)',
  '255,255,255': 'var(--oh-alias-label-primary)',
  '85,85,85': 'var(--oh-alias-label-tertiary)',
  '187,0,0': 'var(--oh-alias-state-error-primary)',
  '255,85,85': 'var(--oh-alias-state-error-secondary)',
  '0,187,0': 'var(--oh-alias-state-success-primary)',
  '0,255,0': 'var(--oh-alias-state-success-secondary)',
  '187,187,0': 'var(--oh-alias-state-warn-primary)',
  '255,255,85': 'var(--oh-alias-state-warn-secondary)',
  '0,0,187': 'var(--oh-alias-state-business-primary)',
  '85,85,255': 'var(--oh-static-blue-400)',
}
