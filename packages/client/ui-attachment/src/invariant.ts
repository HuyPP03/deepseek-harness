/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-attachment`.
 * @module @open-harness/oh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-attachment'
