/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-mcp`.
 * @module @open-harness/oh-client-ui-mcp/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-mcp'
