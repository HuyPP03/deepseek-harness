/**
 * Package-owned invariant companion for `@open-harness/oh-client-web`.
 * @module @open-harness/oh-client-web/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-web'
