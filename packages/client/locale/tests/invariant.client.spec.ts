...
describe('invariant companion', () => {
  ...
  it('client apply provides ctx.locale seeded with the en/vi/zh common namespace', async () => {
    ...
    expect(() => (locale as LocaleRuntime).register(COMMON_NS, 'vi', {})).toThrow('already has locale')
