/**
 * Package-owned invariant companion for `@open-harness/oh-client-locale`.
 * @module @open-harness/oh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-locale'
