...
} from '@open-harness/oh-client-ui-slots'
...
export type { Translate, TranslateNS } from '@open-harness/oh-client-ui-slots'
...
export interface LocaleDefinition {
  ...
  id: LocaleId
  /** Display name in its own language (English / Tiếng Việt / 中文). */
  label: string
}
...
/** The three shipped locales, in display order. */
...
export class LocaleRuntime {
   ...
   * compile error), and every shipped locale is required (trilingual balance
...
export function apply(ctx: ClientContext): void {
  ...
  locale.register(COMMON_NS, { en, vi, zh })
  locale.register(SETTINGS_NS, { en: settingsEn, vi: settingsVi, zh: settingsZh })
