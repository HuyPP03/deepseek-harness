/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-goal`.
 * @module @open-harness/oh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-goal'
