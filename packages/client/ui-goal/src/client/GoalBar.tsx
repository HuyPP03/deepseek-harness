...
import type { GoalSnapshot } from '@open-harness/oh-goal/client'
import {
...
export type GoalDockProps = import('@open-harness/oh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
