...
import { ConversationEventRegistry } from '@open-harness/oh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@open-harness/oh-goal/client'
