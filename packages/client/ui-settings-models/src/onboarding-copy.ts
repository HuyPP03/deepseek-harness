...
export const WELCOME_NOTICE_COPY = {
  ...
  vi: {
    ...
    body: 'Phiên bản 0.1 hiện tại của Open Harness vẫn đang ở giai đoạn kiểm thử dành cho các nhà phát triển Harness, còn nhiều điểm cần cải thiện và hoàn thiện, và chúng tôi mong nhận được phản hồi từ cộng đồng nhà phát triển. Các plugin lõi và API nền tảng của Open Harness dự kiến sẽ tiếp tục lặp đổi nhanh và tiến hóa trong thời gian tới.\n\nChúng tôi mong muốn cùng các nhà phát triển trên toàn cầu, trên nền hạ tầng mã nguồn mở, mở, có thể tái sử dụng và có thể tổ hợp, cùng khám phá giới hạn của trí thông minh. Chào đón các nhà phát triển Harness trên toàn cầu tham gia hệ sinh thái plugin Open Harness.',
