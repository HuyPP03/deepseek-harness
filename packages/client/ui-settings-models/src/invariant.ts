/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-settings-models`.
 * @module @open-harness/oh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-settings-models'
