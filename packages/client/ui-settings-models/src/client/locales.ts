...
/** Vietnamese strings (same keys as {@link en}). */
export const vi: { [Key in keyof typeof en]: string } = {
  nav: 'Mô hình',
  title: 'Mô hình',
  intro: 'Nhập API key của bạn để sử dụng mô hình từ các nhà cung cấp sau.',
  edit: 'Chỉnh sửa',
  ...
  deleteDescription:
    'Xóa {provider} sẽ gỡ cấu hình của nó. Thông tin xác thực mà nó dùng '
    + 'được quản lý ở nơi khác và sẽ được giữ lại.',
  deleteDescriptionWithCredential: 'Xóa {provider} sẽ gỡ cấu hình của nó và API key đã lưu.',
  ...
  readOnly: 'Tài liệu cài đặt ở chế độ chỉ đọc trên bộ triển khai này.',
  loadFailed: 'Không tải được thư mục nhà cung cấp',
  conflict:
    'Ai đó đã thay đổi các cài đặt này trong khi thẻ đang mở. '
    + 'Đóng và mở lại để chỉnh sửa các giá trị hiện tại.',
  retry: 'Thử lại',
  keyInput: 'API key',
  keyPlaceholder: 'Nhập API key của bạn',
  ...
  modelsEmpty:
    'Không có mô hình nào được hiển thị trong trình chọn. '
    + 'ID không nằm trong danh sách vẫn có thể gửi trực tiếp.',
  keyBlank: 'Nhập API key, hoặc để trống trường này để giữ API key đã lưu.',
  keyBlankNew: 'Nhập API key, hoặc để trống nếu nhà cung cấp này xác thực bằng cách khác.',
  keyIllegalCharacters: 'API key này không đúng định dạng. Hãy kiểm tra lại.',
  modelIdRequired: 'Bắt buộc nhập ID mô hình.',
  ...
  advancedHint: 'Các trường khác nằm trong settings.yaml; hãy chỉnh sửa trực tiếp phần đó.',
  modelCapacityInvalid: 'Dung lượng phải là số, có thể có hậu tố K hoặc M.',
  modelDuplicate: 'Mỗi ID mô hình chỉ xuất hiện một lần.',
  modelContextWindow: 'Cửa sổ ngữ cảnh',
  modelMaxTokens: 'Số token đầu ra tối đa',
  fetchModels: 'Lấy danh sách mô hình khả dụng',
  fetching: 'Đang hỏi nhà cung cấp\u2026',
  fetchNeedsBaseUrl: 'Hãy nhập URL gốc trước, sau đó lấy.',
  fetchEmpty: 'Nhà cung cấp không liệt kê mô hình nào. Hãy thêm thủ công.',
  fetchTitle: 'Chọn mô hình cần thêm',
  fetchDescription:
    'Đây là các mô hình mà nhà cung cấp này có khả dụng. '
    + 'Chọn những mô hình cần thêm.',
  fetchAdopt: 'Thêm đã chọn',
  customAdd: 'Thêm nhà cung cấp tùy chỉnh',
  customTitle: 'Nhà cung cấp tùy chỉnh',
  customTag: 'Tùy chỉnh',
  customRoute: 'ID nhà cung cấp',
  customRouteHint:
    'Định danh chữ thường, bắt đầu bằng chữ cái, dùng để gọi tên duy nhất '
    + 'nhà cung cấp này trong các request và làm tên thông tin xác thực.',
  customRouteInvalid: 'Bắt đầu bằng chữ cái thường; sau đó là chữ thường, chữ số và gạch nối.',
  ...
  customNeedsBaseUrl: 'Nhà cung cấp tùy chỉnh cần URL gốc.',
  customNeedsModels: 'Nhà cung cấp tùy chỉnh cần ít nhất một mô hình.',
  create: 'Tạo nhà cung cấp',
  creating: 'Đang tạo\u2026',
  welcomeTitle: WELCOME_NOTICE_COPY.vi.title,
  welcomeBody: WELCOME_NOTICE_COPY.vi.body,
  welcomeContinue: WELCOME_NOTICE_COPY.vi.continueLabel,
  welcomeError: 'Không thể lưu xác nhận. Vui lòng thử lại.',
