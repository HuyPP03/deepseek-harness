/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-sidebar`.
 * @module @open-harness/oh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-sidebar'
