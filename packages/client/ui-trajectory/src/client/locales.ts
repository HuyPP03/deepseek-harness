...
/** The trajectory dictionary key set (the source of truth for every locale). */
...
// The vi table deliberately mirrors en: trajectory is a developer inspection
// surface, ruled out of translation by the locale rollout decision, so the
// duplication is the boundary, not a missed extraction.
/* jscpd:ignore-start */
