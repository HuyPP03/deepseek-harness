/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-trajectory`.
 * @module @open-harness/oh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-trajectory'
