 ...
 * not built (`pnpm --filter @open-harness/oh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@open-harness/oh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@open-harness/oh-client-runtime/client', await import('@open-harness/oh-client-runtime/client')],
      ['@open-harness/oh-client-ui-primitives', await import('@open-harness/oh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@open-harness/oh-client-locale/client')
