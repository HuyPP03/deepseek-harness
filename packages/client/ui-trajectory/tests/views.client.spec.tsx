...
import type { ConvViewProps, ViewTab } from '@open-harness/oh-client-ui-conversation/client'
import {
  ConversationSession, ConversationSessionHeader,
  type ConversationSessionHeaderProps, type ConversationSessionProps,
} from '@open-harness/oh-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@open-harness/oh-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@open-harness/oh-client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@open-harness/oh-client-locale/client'
import { stubSettingsScope } from '@open-harness/oh-client-test-runtime'
import type { LocaleKeysOf } from '@open-harness/oh-client-ui-slots'
import { zh, type TrajectoryKey } from '../src/client/locales.ts'
import { apply, inject } from '@open-harness/oh-client-ui-trajectory/client'
import { apply as nodeApply } from '@open-harness/oh-client-ui-trajectory'
...
describe('plugin registration', () => {
  ...
  it('shares one browser-wide duration preference across session injections', async () => {
    ...
    expect(localStorage.getItem('oh.trajectory.duration')).toBe('true')
    expect(localStorage.getItem(`oh.trajectory.duration.${SID}`)).toBeNull()
  })
