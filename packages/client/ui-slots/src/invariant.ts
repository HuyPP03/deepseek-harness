/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-slots`.
 * @module @open-harness/oh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-slots'
