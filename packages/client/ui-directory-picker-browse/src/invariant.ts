/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-directory-picker-browse`.
 * @module @open-harness/oh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-directory-picker-browse'
