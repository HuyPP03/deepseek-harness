/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-subagent`.
 * @module @open-harness/oh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-subagent'
