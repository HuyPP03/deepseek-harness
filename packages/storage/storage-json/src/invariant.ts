/**
 * Package-owned invariant companion for `@open-harness/oh-storage-json`.
 * @module @open-harness/oh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-storage-json'
