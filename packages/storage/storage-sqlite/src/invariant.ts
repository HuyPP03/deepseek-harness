/**
 * Package-owned invariant companion for `@open-harness/oh-storage-sqlite`.
 * @module @open-harness/oh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-storage-sqlite'
