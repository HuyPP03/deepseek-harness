/**
 * Package-owned invariant companion for `@open-harness/oh-session-persistence-jsonl`.
 * @module @open-harness/oh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-persistence-jsonl'
