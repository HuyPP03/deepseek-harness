/**
 * Package-owned invariant companion for `@open-harness/oh-session-projection-cache`.
 * @module @open-harness/oh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-projection-cache'
