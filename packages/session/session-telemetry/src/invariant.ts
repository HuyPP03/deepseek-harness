/**
 * Package-owned invariant companion for `@open-harness/oh-session-telemetry`.
 * @module @open-harness/oh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-telemetry'
