/**
 * Package-owned invariant companion for `@open-harness/oh-session-title-all-prompts-llm`.
 * @module @open-harness/oh-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-title-all-prompts-llm'
