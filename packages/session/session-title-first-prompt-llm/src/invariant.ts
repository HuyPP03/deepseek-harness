/**
 * Package-owned invariant companion for `@open-harness/oh-session-title-first-prompt-llm`.
 * @module @open-harness/oh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-title-first-prompt-llm'
