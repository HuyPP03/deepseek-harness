/**
 * Package-owned invariant companion for `@open-harness/oh-session-persistence-sqlite`.
 * @module @open-harness/oh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-persistence-sqlite'
