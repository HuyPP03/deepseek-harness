/**
 * OpenTelemetry Service Provider for the Open Harness telemetry capability.
 *
 ...
 *
 * @module @open-harness/oh-session-telemetry-otel
 */
...
} from '@open-harness/oh-session-telemetry'
import { APP_IDENTITY } from '@open-harness/oh-llm'
...
// version (same pattern as oh-llm's attribution identity).
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@open-harness/oh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@open-harness/oh-session-telemetry-otel/ops', version)
