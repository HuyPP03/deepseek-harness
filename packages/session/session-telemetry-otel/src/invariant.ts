/**
 * Package-owned invariant companion for `@open-harness/oh-session-telemetry-otel`.
 * @module @open-harness/oh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-telemetry-otel'
