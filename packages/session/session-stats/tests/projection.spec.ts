...
import { sessionStatsProjectionDefinition } from '@open-harness/oh-session-stats/src/projection.ts'
import type { SessionStatsProjection } from '@open-harness/oh-session-stats/types'
