/**
 * Package-owned invariant companion for `@open-harness/oh-session-stats`.
 * @module @open-harness/oh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-stats'
 ...
 * ids) are owned and runtime-checked by oh-agent-loop and the session
 * surface, not here.
 */
