 ...
 * (`deriveStats` in oh-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @open-harness/oh-session-stats/projection
 */

import { z } from 'zod'
import { isTokenDelta } from '@open-harness/oh-llm/message'
