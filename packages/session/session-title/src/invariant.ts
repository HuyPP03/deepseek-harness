/**
 * Package-owned invariant companion for `@open-harness/oh-session-title`.
 * @module @open-harness/oh-session-title/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-title'
