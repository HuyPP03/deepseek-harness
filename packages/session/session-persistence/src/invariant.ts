/**
 * Package-owned invariant companion for `@open-harness/oh-session-persistence`.
 * @module @open-harness/oh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-persistence'
