/**
 * Package-owned invariant companion for `@open-harness/oh-session-projection`.
 * @module @open-harness/oh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-projection'
