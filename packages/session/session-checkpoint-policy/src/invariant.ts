/**
 * Package-owned invariant companion for `@open-harness/oh-session-checkpoint-policy`.
 * @module @open-harness/oh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-checkpoint-policy'
