/**
 * Package-owned invariant companion for `@open-harness/oh-session-title-llm`.
 * @module @open-harness/oh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-title-llm'
