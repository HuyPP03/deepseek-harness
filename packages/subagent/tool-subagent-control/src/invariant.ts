/**
 * Package-owned invariant companion for `@open-harness/oh-tool-subagent-control`.
 * @module @open-harness/oh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-tool-subagent-control'
