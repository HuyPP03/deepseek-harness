/**
 * Package-owned invariant companion for `@open-harness/oh-tool-subagent`.
 * @module @open-harness/oh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-tool-subagent'
