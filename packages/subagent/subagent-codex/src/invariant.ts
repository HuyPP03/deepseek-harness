/**
 * Package-owned invariant companion for `@open-harness/oh-subagent-codex`.
 * @module @open-harness/oh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-subagent-codex'
