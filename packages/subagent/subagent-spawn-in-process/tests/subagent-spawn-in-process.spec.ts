...
import { Context, symbols, type EffectMeta } from '@open-harness/cordis'
...
import SubagentRuntime, { type SubagentStartRequest } from '@open-harness/oh-subagent'
import { MockAdapter, maxTokensResponse, textResponse, toolCallResponse } from '../../../core/agent-loop/tests/mock-adapter.ts'
import * as spawn from '../src/index.ts'
import { STRUCTURED_OUTPUT_TOOL } from '@open-harness/oh-subagent-in-process-driver'
...
describe('oh-subagent-spawn-in-process', () => {
