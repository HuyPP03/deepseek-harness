...
import type { SessionProjectionCache } from '@open-harness/oh-session-projection-cache'
...
async function prepareListing(
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @open-harness/oh-session)',
