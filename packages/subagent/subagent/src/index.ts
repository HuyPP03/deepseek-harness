 ...
 * (`@open-harness/oh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@open-harness/oh-tool-subagent`) are separate packages.
 *
...
import type { ContentBlock, MessageId } from '@open-harness/oh-llm'
