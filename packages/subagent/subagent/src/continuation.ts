...
import { boundContextSummary, createUserMessage, errorChain } from '@open-harness/oh-llm'
import type { ContentBlock, MessageId, MessageSource } from '@open-harness/oh-llm'
...
import type { ToolRestriction } from '@open-harness/oh-tools'
...
export class SubagentContinuationManager {
  ...
  private requirePersistence(): SessionPersistence {
    ...
    if (persistence === undefined) {
      throw new SubagentError(
        'continuable subagents require session persistence (load a oh-session-persistence backend)',
