 ...
 *
 * @module @open-harness/oh-subagent/types
 */

import type { Agent, AgentOptions } from '@open-harness/oh-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@open-harness/oh-tools'
