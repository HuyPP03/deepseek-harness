...
import type { ProjectionDefinition } from '@open-harness/oh-session-projection'
import SessionProjectionCache from '@open-harness/oh-session-projection-cache'
...
async function setup(
  ...
  const root = mkdtempSync(join(tmpdir(), 'oh-subagent-list-'))
  roots.push(root)
