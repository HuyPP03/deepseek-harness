/**
 * Package-owned invariant companion for `@open-harness/oh-tool-subagent-report`.
 * @module @open-harness/oh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-tool-subagent-report'
