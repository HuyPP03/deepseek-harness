 ...
 *
 * @module oh-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from '@open-harness/oh-llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryRequest } from '@open-harness/oh-llm'
import { attributionHeaders } from '@open-harness/oh-llm'
 ...
 * on the length the server claims — the same two-stage shape `oh-web-fetch`
