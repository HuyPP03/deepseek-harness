...
} from '@open-harness/oh-attachment'
import LlmRuntime, { createUserMessage, CallId } from '@open-harness/oh-llm'
import type { Message, ToolSchema } from '@open-harness/oh-llm'
import * as LlmPiAi from '@open-harness/oh-llm-pi-ai'
...
const openAIBaseURL = process.env.OH_PI_AI_OPENAI_BASE_URL
...
const anthropicBaseURL = process.env.OH_PI_AI_ANTHROPIC_BASE_URL

const providerCases: ProviderCase[] = [
  {
    provider: 'openai',
    api: 'openai-responses',
    model: process.env.OH_PI_AI_OPENAI_MODEL ?? 'gpt-5.5',
    ...azureOpenAIKey
  ...
  },
  {
    ...
    model: process.env.OH_PI_AI_ANTHROPIC_MODEL ?? 'claude-opus-4-8',
