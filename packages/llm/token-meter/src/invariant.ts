/**
 * Package-owned invariant companion for `@open-harness/oh-token-meter`.
 * @module @open-harness/oh-token-meter/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-token-meter'
