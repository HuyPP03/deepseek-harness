/**
 * Package-owned invariant companion for `@open-harness/oh-tool-terminal`.
 * @module @open-harness/oh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-tool-terminal'
