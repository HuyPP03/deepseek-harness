/**
 * Package-owned invariant companion for `@open-harness/oh-anonymous-user-id`.
 * @module @open-harness/oh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-anonymous-user-id'
