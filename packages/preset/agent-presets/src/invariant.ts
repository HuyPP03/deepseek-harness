/**
 * Package-owned invariant companion for `@open-harness/oh-agent-presets`.
...
import { leakedServices, livePresetMounts } from '@open-harness/oh-agent-presets'

const PACKAGE_NAME = '@open-harness/oh-agent-presets'
