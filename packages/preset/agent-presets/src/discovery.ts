 ...
 * @module @open-harness/oh-agent-presets/discovery
 */
...
import { expandHomePath } from '@open-harness/oh-home-paths'
 ...
 *
 * This package owns the writable root the way `oh-skill-filesystem` owns
 * `<ohHome>/skills`. An app must assemble the SHIPPED root, whose path only
