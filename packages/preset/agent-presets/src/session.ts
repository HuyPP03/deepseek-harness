 ...
 * preset after it started — blank through the seat flow, or mid-conversation
 * through the `/mode` command — and the effect of that change outlives the
 * moment it was made: every turn after it runs under the newly mounted
 * composition. Recording the change is what keeps the log honest, and it is
 * required outright by the repo's model-visible ⟺ logged rule, since the
 ...
 * @module @open-harness/oh-agent-presets/session
 */
