/**
 * Package-owned invariant companion for `@open-harness/oh-jobs-local`.
 * @module @open-harness/oh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-jobs-local'
...
/**
 * No runtime invariant: `@open-harness/oh-jobs/invariant` owns per-snapshot identity, status,
