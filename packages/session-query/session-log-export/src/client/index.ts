...
import type {} from '@open-harness/oh-client-ui-commands/client'
...
import { en, NS, vi, zh, type SessionLogDownloadKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { en, vi, zh }), 'session-log-download: browser dictionaries')
