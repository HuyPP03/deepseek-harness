/**
 * Package-owned invariant companion for `@open-harness/oh-session-query-sqlite`.
 * @module @open-harness/oh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-query-sqlite'
