/**
 * Package-owned invariant companion for `@open-harness/oh-session-query`.
 * @module @open-harness/oh-session-query/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-query'
