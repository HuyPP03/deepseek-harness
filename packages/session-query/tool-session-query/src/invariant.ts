/**
 * Package-owned invariant companion for `@open-harness/oh-tool-session-query`.
 * @module @open-harness/oh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-tool-session-query'
