...
import type { TypertLookup } from '@open-harness/oh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@open-harness/oh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@open-harness/oh-session#Session',
