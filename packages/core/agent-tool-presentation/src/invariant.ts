/**
 * Package-owned invariant companion for `@open-harness/oh-agent-tool-presentation`.
 * @module @open-harness/oh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-agent-tool-presentation'
 ...
 * registry's to hold, and `oh-tools` observes it there.
 */
