/**
 * Package-owned invariant companion for `@open-harness/oh-command-compact`.
 * @module @open-harness/oh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-command-compact'
