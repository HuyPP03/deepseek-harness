...
import CommandRuntime, { type CommandResult } from '@open-harness/oh-commands'
import {
  CompactionId,
  CompactionEngine,
...
import * as commandCompact from '@open-harness/oh-command-compact'
...
describe('@open-harness/oh-command-compact registration', () => {
