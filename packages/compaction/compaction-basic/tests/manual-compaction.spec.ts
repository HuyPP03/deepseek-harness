...
import { CommandId } from '@open-harness/oh-commands/brand'
...
import * as CompactionInvariant from '@open-harness/oh-compaction/invariant'
import * as CompactionBasicInvariant from '@open-harness/oh-compaction-basic/invariant'
import { BasicCompactionEngine } from '@open-harness/oh-compaction-basic'
import { CompactionId, isCompactCheckpointSource, ManualCompactionError } from '@open-harness/oh-compaction'
...
import type {
  SummarizationInput,
  SummaryResult,
} from '@open-harness/oh-compaction-basic/src/summarizer.ts'
