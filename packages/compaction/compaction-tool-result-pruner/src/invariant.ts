/**
 * Package-owned invariant companion for `@open-harness/oh-compaction-tool-result-pruner`.
 * @module @open-harness/oh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-compaction-tool-result-pruner'
