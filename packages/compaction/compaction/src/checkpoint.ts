 ...
 *
 * The seam itself lives in `@open-harness/oh-compaction`, which re-exports these
 ...
 * `oh-commands/brand` shape.
 *
 * @module @open-harness/oh-compaction/checkpoint
 */

import type { MessageSource } from '@open-harness/oh-llm/message'
