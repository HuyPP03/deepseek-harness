/**
 * Package-owned invariant companion for `@open-harness/oh-workflow-worker-thread`.
 * @module @open-harness/oh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-workflow-worker-thread'
