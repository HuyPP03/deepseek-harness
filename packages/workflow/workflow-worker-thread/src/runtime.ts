 ...
 * @module @open-harness/oh-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@open-harness/oh-llm'
import { SessionId } from '@open-harness/oh-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@open-harness/oh-tools'
import type { ObjectJsonSchema } from '@open-harness/oh-tools'
import { isFatalWorkflowError, WorkflowError } from '@open-harness/oh-workflow'
import type {
