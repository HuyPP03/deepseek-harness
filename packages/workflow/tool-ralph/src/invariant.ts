/**
 * Package-owned invariant companion for `@open-harness/oh-tool-ralph`.
 * @module @open-harness/oh-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-tool-ralph'
