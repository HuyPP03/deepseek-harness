/**
 * Package-owned invariant companion for `@open-harness/oh-tool-call-timeout-policy`.
 * @module @open-harness/oh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-tool-call-timeout-policy'
