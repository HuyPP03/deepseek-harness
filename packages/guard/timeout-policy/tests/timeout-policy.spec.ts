/**
 * Unit + real-load-path coverage for @open-harness/oh-tool-call-timeout-policy. The
...
import { TOOL_TIMEOUT } from '@open-harness/oh-tool-call-timeout-policy'
...
describe('oh-tool-call-timeout-policy real-load-path guard', () => {
