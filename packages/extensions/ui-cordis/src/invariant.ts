/**
 * Package-owned invariant companion for `@open-harness/oh-client-ui-cordis`.
 * @module @open-harness/oh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-ui-cordis'
