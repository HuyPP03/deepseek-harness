...
import type {} from '@open-harness/oh-client-ui-tool/client'
...
import type { InputTriggerService, InputTriggerSource } from '@open-harness/oh-client-ui-input-trigger/client'
...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { en, vi, zh }), 'ui-cordis: dictionaries')
