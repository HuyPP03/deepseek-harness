/**
 * Package-owned invariant companion for `@open-harness/oh-cordis-client-runner`.
 * @module @open-harness/oh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-cordis-client-runner'
