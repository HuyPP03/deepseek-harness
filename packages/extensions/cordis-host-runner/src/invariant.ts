/**
 * Package-owned invariant companion for `@open-harness/oh-cordis-host-runner`.
 * @module @open-harness/oh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-cordis-host-runner'
