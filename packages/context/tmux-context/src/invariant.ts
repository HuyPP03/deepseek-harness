/**
 * Package-owned invariant companion for `@open-harness/oh-tmux-context`.
 * @module @open-harness/oh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-tmux-context'
