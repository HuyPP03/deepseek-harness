 ...
 *
 * @module @open-harness/oh-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$OH_HOME`.
 * Discovery (`$OH_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.oh/AGENTS.md' || displayPath === '$OH_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
