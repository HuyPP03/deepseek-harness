/**
 * Package-owned invariant companion for `@open-harness/oh-agent-instructions`.
 * @module @open-harness/oh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-agent-instructions'
