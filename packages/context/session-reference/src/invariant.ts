/**
 * Package-owned invariant companion for `@open-harness/oh-session-reference`.
 * @module @open-harness/oh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-session-reference'
