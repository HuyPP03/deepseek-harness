/**
 * Package-owned invariant companion for `@open-harness/oh-llm-replay`.
 * @module @open-harness/oh-llm-replay/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-llm-replay'
