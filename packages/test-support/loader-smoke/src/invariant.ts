/**
 * Package-owned invariant companion for `@open-harness/oh-loader-smoke`.
 * @module @open-harness/oh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-loader-smoke'
