/**
 * Package-owned invariant companion for `@open-harness/oh-agent-loop-testkit`.
 * @module @open-harness/oh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-agent-loop-testkit'
