/**
 * Package-owned invariant companion for `@open-harness/oh-acp-snapshot`.
 * @module @open-harness/oh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-acp-snapshot'
