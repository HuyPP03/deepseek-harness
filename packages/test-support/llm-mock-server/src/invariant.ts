/**
 * Package-owned invariant companion for `@open-harness/oh-llm-mock-server`.
 * @module @open-harness/oh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-llm-mock-server'
