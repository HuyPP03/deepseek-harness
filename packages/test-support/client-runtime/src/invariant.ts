/**
 * Package-owned invariant companion for `@open-harness/oh-client-test-runtime`.
 * @module @open-harness/oh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-client-test-runtime'
