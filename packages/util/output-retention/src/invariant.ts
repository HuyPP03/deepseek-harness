/**
 * Package-owned invariant companion for `@open-harness/oh-output-retention`.
 * @module @open-harness/oh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-output-retention'
