/**
 * Package-owned invariant companion for `@open-harness/oh-atomic-write`.
 * @module @open-harness/oh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-atomic-write'
