 ...
 *
 * @module @open-harness/oh-home-paths
 */
...
/** Environment variable that overrides the default Open Harness home. */
export const OH_HOME_ENV = 'OH_HOME'
...
/**
 * Resolve the default Open Harness home using Node's platform path rules.
 * @returns the absolute default harness home path.
 */
export function defaultDshHome(): string {
  return join(homedir(), OH_HOME_DIR_NAME)
}
...
/**
 * Join path segments onto the resolved Open Harness home.
