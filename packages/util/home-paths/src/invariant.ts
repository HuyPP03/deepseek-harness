/**
 * Package-owned invariant companion for `@open-harness/oh-home-paths`.
 * @module @open-harness/oh-home-paths/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-home-paths'
