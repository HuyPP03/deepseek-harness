/**
 * Package-owned invariant companion for `@open-harness/oh-native-command`.
 * @module @open-harness/oh-native-command/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-native-command'
