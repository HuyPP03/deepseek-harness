 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in oh-llm (tool-call
 * correlation), the shared agent/session `SessionId` in oh-session, and
 * `JobId` in oh-jobs. Branding is for ids that cross package boundaries and
