/**
 * Package-owned invariant companion for `@open-harness/oh-launch-environment`.
 * @module @open-harness/oh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-launch-environment'
