...
Optional bundled skill provider that contributes `oh-badge` to `ctx.skills`. The skill supplies the official “powered by oh” Markdown snippets and the packaged PNG for systems that cannot import a remote image reliably.
