/**
 * Package-owned invariant companion for `@open-harness/oh-skill-badge`.
 * @module @open-harness/oh-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-skill-badge'
