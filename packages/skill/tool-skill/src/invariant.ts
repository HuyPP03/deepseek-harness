/**
 * Package-owned invariant companion for `@open-harness/oh-tool-skill`.
 * @module @open-harness/oh-tool-skill/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-tool-skill'
