 ...
 * Concrete
 * providers such as `@open-harness/oh-skill-filesystem` decide where skills come
...
export type SkillSource = 'project-oh' | 'project-agents' | 'runtime' | 'user-oh' | 'user-agents' | 'custom' | 'bundled' | (string & {})
