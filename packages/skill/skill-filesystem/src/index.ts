 ...
 *
 * @module @open-harness/oh-skill-filesystem
 */
...
import type { FileSystem, FsDirEntry, FsTarget } from '@open-harness/oh-fs'
...
export class FileSystemSkillProvider implements SkillProvider {
  ...
  constructor(
    ...
    const bundledSkillDir = config.bundledSkillDir
      ?? (this.includeDefaultRoots ? process.env.OH_BUNDLED_SKILL_DIR : undefined)
