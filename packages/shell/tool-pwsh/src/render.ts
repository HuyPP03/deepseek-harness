 ...
 * `oh-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @open-harness/oh-tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@open-harness/oh-shell'
...
/* jscpd:ignore-start -- deliberate twin of oh-tool-bash/render.ts (Agent Note). */
