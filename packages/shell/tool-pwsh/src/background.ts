 ...
 * twin of `oh-tool-bash`'s background adaptation.
 *
 * @module @open-harness/oh-tool-pwsh/background
 */

import type { ShellProcess } from '@open-harness/oh-shell'

/* jscpd:ignore-start -- deliberate twin of oh-tool-bash/background.ts (Agent Note). */
