/**
 * Real-process tests for `@open-harness/oh-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@open-harness/oh-pwsh-local'
...
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@open-harness/oh-subprocess'
