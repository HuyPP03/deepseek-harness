/**
 * Package-owned invariant companion for `@open-harness/oh-pwsh-sandbox`.
 * @module @open-harness/oh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-pwsh-sandbox'
