 ...
 *
 * @module @open-harness/oh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@open-harness/oh-shell'
import type { SandboxMode } from '@open-harness/oh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@open-harness/oh-sandbox'
 ...
 * rendering story, owned by `@open-harness/oh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@open-harness/oh-shell'
