/**
 * Package-owned invariant companion for `@open-harness/oh-tool-bash-persistent`.
 * @module @open-harness/oh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-tool-bash-persistent'
