...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@open-harness/oh-tools'
import type { WebFetchBody, WebFetchResult } from '@open-harness/oh-web'
 ...
 * `@open-harness/oh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@open-harness/oh-tool-call-timeout-policy` to enforce.
