 ...
 * `@open-harness/oh-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @open-harness/oh-web-fetch-http/provider
 */

import { WebError } from '@open-harness/oh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@open-harness/oh-web'
