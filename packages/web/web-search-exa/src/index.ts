/**
 * `@open-harness/oh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@open-harness/oh-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@open-harness/oh-web`.
 *
