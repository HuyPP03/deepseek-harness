/**
 * Package-owned invariant companion for `@open-harness/oh-web-search-deepseek`.
 * @module @open-harness/oh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-web-search-deepseek'
