...
npm scope: `@deepseek-ai/dsh-*`; Cordis `Service` subclasses + function plugins contribute through `ctx.effect()`, `ctx.on()`, or `ctx.waterfall()`. Rules: [package](AGENTS.md), [root](../AGENTS.md#conventions).
