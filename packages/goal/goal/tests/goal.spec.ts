...
import SessionStore, { Session, SessionId, type UserMessage } from '@open-harness/oh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@open-harness/oh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@open-harness/oh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@open-harness/oh-session').SessionEvent[]): StubAgent {
