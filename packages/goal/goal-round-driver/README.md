# @open-harness/oh-goal-round-driver
...
- id: goal-round-driver
  name: '@open-harness/oh-goal-round-driver'
```

The plugin has no tunable configuration. `maxGoalRounds` belongs to the goal definition, while the model-facing blocked threshold belongs to [`oh-tool-goal`](../tool-goal/README.md); duplicating either value in the driver could produce divergent policy.
