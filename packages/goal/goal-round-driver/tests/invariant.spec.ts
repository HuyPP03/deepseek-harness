...
import * as GoalSessionInvariant from '@open-harness/oh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@open-harness/oh-goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@open-harness/oh-goal-round-driver',
    }))
  })
