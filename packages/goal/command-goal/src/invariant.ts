/**
 * Package-owned invariant companion for `@open-harness/oh-command-goal`.
 * @module @open-harness/oh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-command-goal'
