...
import type { GoalRef } from '@open-harness/oh-goal'
import SessionStore, { Session, SessionId } from '@open-harness/oh-session'
import * as commandGoal from '@open-harness/oh-command-goal'
...
describe('@open-harness/oh-command-goal registration', () => {
