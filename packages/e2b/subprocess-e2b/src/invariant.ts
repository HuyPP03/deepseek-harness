/**
 * Package-owned invariant companion for `@open-harness/oh-subprocess-e2b`.
 * @module @open-harness/oh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-subprocess-e2b'
