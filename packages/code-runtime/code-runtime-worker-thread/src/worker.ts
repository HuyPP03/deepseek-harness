 ...
 * @module @open-harness/oh-code-runtime-worker-thread/src/worker
 */
...
if (!parentPort) throw new Error('oh-code-runtime-worker-thread: worker entry loaded outside a worker thread')
