/** JSON string-prefix accounting for the outer-output ledger. @module @open-harness/oh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@open-harness/oh-code-runtime'
