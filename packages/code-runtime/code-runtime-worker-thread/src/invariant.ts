/**
 * Package-owned invariant companion for `@open-harness/oh-code-runtime-worker-thread`.
 * @module @open-harness/oh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-code-runtime-worker-thread'
