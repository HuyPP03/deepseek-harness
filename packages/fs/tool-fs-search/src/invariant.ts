/**
 * Package-owned invariant companion for `@open-harness/oh-tool-fs-search`.
 * @module @open-harness/oh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-tool-fs-search'
