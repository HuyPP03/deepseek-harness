/**
 * Package-owned invariant companion for `@open-harness/oh-sdk-client`.
 * @module @open-harness/oh-sdk-client/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-sdk-client'
