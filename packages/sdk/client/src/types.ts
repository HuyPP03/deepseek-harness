 ...
 *
 * @module @open-harness/oh-sdk-client/types
 */
...
export interface HarnessClientOptions {
  /** The runtime executable (the `oh-jsonrpc-agent` bin, a packaged exe, or `node`). */
  command: string
   ...
   * credential policy (see `scrubbedParentEnv` in `@open-harness/oh-subprocess`
