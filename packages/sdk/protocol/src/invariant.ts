/**
 * Package-owned invariant companion for `@open-harness/oh-sdk-protocol`.
 * @module @open-harness/oh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-sdk-protocol'
