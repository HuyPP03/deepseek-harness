/**
 * Package-owned invariant companion for `@open-harness/oh-sdk-jsonrpc-server`.
 * @module @open-harness/oh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-sdk-jsonrpc-server'
