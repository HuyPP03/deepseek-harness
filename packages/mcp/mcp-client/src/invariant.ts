/**
 * Package-owned invariant companion for `@open-harness/oh-mcp-client`.
 * @module @open-harness/oh-mcp-client/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-mcp-client'
