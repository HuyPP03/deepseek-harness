/**
 * Package-owned invariant companion for `@open-harness/oh-typert-generator`.
 * @module @open-harness/oh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-typert-generator'
