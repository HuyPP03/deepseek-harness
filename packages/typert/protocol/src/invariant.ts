/**
 * Package-owned invariant companion for `@open-harness/oh-typert-protocol`.
 * @module @open-harness/oh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-typert-protocol'
