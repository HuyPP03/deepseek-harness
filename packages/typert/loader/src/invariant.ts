/**
 * Package-owned invariant companion for `@open-harness/oh-typert-loader`.
 * @module @open-harness/oh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-typert-loader'
