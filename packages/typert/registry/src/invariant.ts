/**
 * Package-owned invariant companion for `@open-harness/oh-typert-registry`.
 * @module @open-harness/oh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-typert-registry'
