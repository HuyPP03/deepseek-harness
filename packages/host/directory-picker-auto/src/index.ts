 ...
 * @module @open-harness/oh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@open-harness/oh-host-directory-picker-native',
  browse: '@open-harness/oh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@open-harness/oh-client-ui-directory-picker-native',
  browse: '@open-harness/oh-client-ui-directory-picker-browse',
}
