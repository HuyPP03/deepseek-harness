/**
 * Package-owned invariant companion for `@open-harness/oh-host-frontend-static`.
 * @module @open-harness/oh-host-frontend-static/invariant
 */

import type { Context } from '@open-harness/cordis'
import type { InvariantInstaller } from '@open-harness/oh-invariants'

const PACKAGE_NAME = '@open-harness/oh-host-frontend-static'
