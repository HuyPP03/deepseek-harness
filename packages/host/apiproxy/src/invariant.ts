/**
 * Package-owned invariant companion for `@open-harness/oh-host-apiproxy`.
 * @module @open-harness/oh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-host-apiproxy'
