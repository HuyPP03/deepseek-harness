...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef } from '@open-harness/oh-attachment'
 ...
 * the oh-tools vocabulary into this schema and drift with it.
 */
