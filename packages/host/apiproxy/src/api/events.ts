...
import type { AskUserQuestionItem } from '@open-harness/oh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@open-harness/oh-user-approval/types'
import type { Message } from '@open-harness/oh-llm/types'
import type { MessageId } from '@open-harness/oh-llm/brand'
import type { CallId } from '@open-harness/oh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@open-harness/oh-session/types'
import type { ToolCallView, ToolResultView } from '@open-harness/oh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@open-harness/oh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
