...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('references-unsupported'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({ code: z.literal('references-invalid'), message: z.string(), details: z.object({ sessionId: z.string(), reason: z.string() }) }),
  z.object({ code: z.literal('references-require-workspace'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  ...
  z.object({ code: z.literal('job-not-found'), message: z.string(), details: z.object({ sessionId: z.string(), jobId: z.string() }) }),
  z.object({ code: z.literal('job-unauthorized'), message: z.string(), details: z.object({ jobId: z.string() }) }),
  ...
  z.object({ code: z.literal('mcp-server-not-found'), message: z.string(), details: z.object({ serverName: z.string() }) }),
  ...
  z.object({ code: z.literal('connector-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('connector-not-found'), message: z.string(), details: z.object({ id: z.string() }) }),
  z.object({ code: z.literal('connector-exists'), message: z.string(), details: z.object({ id: z.string() }) }),
  z.object({ code: z.literal('connector-not-custom'), message: z.string(), details: z.object({ id: z.string() }) }),
  z.object({ code: z.literal('connector-credential-missing'), message: z.string(), details: z.object({ id: z.string(), ref: z.string() }) }),
  z.object({ code: z.literal('connector-override-missing'), message: z.string(), details: z.object({ id: z.string(), field: z.string() }) }),
  z.object({ code: z.literal('connector-auth-unavailable'), message: z.string(), details: z.object({ id: z.string(), mode: z.union([z.literal('oauth'), z.literal('device')]) }) }),
