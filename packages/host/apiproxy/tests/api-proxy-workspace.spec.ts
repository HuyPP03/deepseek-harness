...
import type { Agent, AgentFactory } from '@open-harness/oh-agent'
...
import type { DirectoryPickerCapability } from '@open-harness/oh-host-directory-picker'
import WorkspaceRegistry from '@open-harness/oh-workspace'
import type { HostFrame, WorkspaceId } from '@open-harness/oh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@open-harness/oh-host-apiproxy/api/rpc'
...
async function harness(
  root = realpathSync.native(mkdtempSync(join(tmpdir(), 'oh-apiproxy-workspace-'))),
