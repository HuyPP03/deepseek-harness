/**
 * Package-owned invariant companion for `@open-harness/oh-api-gateway`.
 * @module @open-harness/oh-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@open-harness/oh-api-gateway'
