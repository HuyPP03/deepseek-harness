...
import type { CordisCatalogModel, ServiceMethodEntry } from '@open-harness/oh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@open-harness/oh-tool-cordis/api-catalog', '@open-harness/oh-cordis-client-runner/client/api-catalog')
