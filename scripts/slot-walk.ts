...
const SLOTS_MODULE = '@open-harness/oh-client-ui-slots'

/** Cheap textual prefilter for a slot-contract merge, quote-style agnostic. Must track {@link SLOTS_MODULE}. */
const MERGE_HEAD = /declare module ['"]@open-harness\/oh-client-ui-slots['"]/
