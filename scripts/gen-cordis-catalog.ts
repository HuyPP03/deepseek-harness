...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@open-harness/oh-typert-generator'
import type { CordisCatalogPolicy } from '@open-harness/oh-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@open-harness/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  detailsPanel: 'client-side interface-typed browser service (details panel open/close gesture) — packages/client/ui-conversation/README.md owns the API',
  ...
  settingsPanel: 'client-side browser service (settings panel open state and active section) — packages/client/ui-settings-general/README.md owns the API',
 ...
 * scan reads EVERY `declare module '@open-harness/cordis'` Events merge under
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ConnectorState: 'connector lifecycle state is owned by packages/connectors/connectors/README.md',
  ConnectorView: 'wire-safe connector view is owned by packages/connectors/connectors/README.md',
  ConnectorManifest: 'connector manifest record is owned by packages/connectors/connectors/README.md',
  ConnectorConfigureFields: 'connector configure fields are owned by packages/connectors/connectors/README.md',
  DeviceFlowStart: 'device-code flow start facts are owned by packages/connectors/device-flow/README.md',
  AddCustomSpec: 'custom connector spec is owned by packages/connectors/connectors/README.md',
  OAuthTokenBundle: 'OAuth token bundle is owned by packages/credentials/oauth-tokens/README.md',
  ...
  McpServerReader: 'service-local reader closure is owned by packages/mcp/mcp-registry/src/index.ts',
  McpServerReporter: 'service-local reporter contract is owned by packages/mcp/mcp-registry/README.md',
  McpServerSpec: 'user-server definition is owned by packages/mcp/mcp-manager/README.md',
  McpServerView: 'service-local snapshot contract is owned by packages/mcp/mcp-registry/src/types.ts',
