...
function checkManifest(
  ...
  if (owner.packageName === '@open-harness/oh-invariants') return
  if (manifest.peerDependencies?.['@open-harness/oh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@open-harness/oh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@open-harness/oh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@open-harness/oh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@open-harness/oh-invariants'
