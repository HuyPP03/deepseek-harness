...
export const TRANSLATION_SCOPE_GLOB_EXCLUDES = [
  ...
  'apps/web/dist/**',
  '.artifacts/**',
  'python/sdk-runtime/src/open_harness_runtime/runtime/oh-jsonrpc-agent-*/**',
  'python/sdk-runtime/src/open_harness_runtime/runtime/node/**',
  'vendor/**',
]
...
function isTranslationSourceExcluded(file: string): boolean {
  ...
  return segments.some(segment => NON_SOURCE_DIRECTORIES.has(segment)
    ...
    || file.startsWith('python/sdk-runtime/src/open_harness_runtime/runtime/oh-jsonrpc-agent-')
    || file.startsWith('python/sdk-runtime/src/open_harness_runtime/runtime/node/')
}
