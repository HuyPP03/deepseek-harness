...
function ciSharedStaticGates(): Gate[] {
  return [
    ...
    pnpmScript('oh-package-licenses', 'verify-oh-package-licenses', { label: 'Open Harness package licenses' }),
...
function docSyncLeafGates(options: {
  ...
  return [
    ...
    pnpmScript('product-copy', 'verify-product-copy', { label: 'product copy' }),
